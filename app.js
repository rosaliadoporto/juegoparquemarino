...
const incidents=[
 ...
 {zone:'zone-solar', key:'solar', icon:'solar', theme:'Solar flotante', badge:'Solar flotante', title:'Solar-03', subtitle:'Plataforma solar flotante', scenario:'Un grupo de plataformas solares está produciendo menos energía de lo habitual aunque hay buena radiación solar.', question:'¿Por qué unos paneles solares en el mar pueden producir cada vez menos energía, aunque siga haciendo sol?', options:['Se acumula sal, algas y suciedad encima.','Los cables se desgastan con el paso del tiempo.','Los paneles no se desgastan nunca.','Las plataformas se mueven con las olas y quedan mal orientadas hacia el sol.'], correct:0, hint:'Piensa en lo que se va acumulando sobre la superficie del panel.', assetIndex:2},
 {zone:'zone-wind', key:'wind', icon:'wind', theme:'Eólica marina', badge:'Eólica marina', title:'EÓLICA-03', subtitle:'Aerogenerador flotante', scenario:'La empresa está decidiendo si construir un nuevo parque eólico en tierra o en el mar, y sus ingenieros recomiendan la opción marina.', question:'¿Cuál es la principal ventaja de instalar aerogeneradores en el mar en vez de en tierra?', options:['El viento en el mar es más fuerte y constante.','El agua del mar refrigera las turbina.','Los aerogeneradores marinos no necesitan menos mantenimiento.','No hay ninguna ventaja.'], correct:1, hint:'Si el viento no falta, busca el problema en la parte eléctrica.', assetIndex:2},
 {zone:'zone-sub', key:'sub', icon:'sub', theme:'Subestación eléctrica', badge:'Subestación eléctrica', title:'SUBESTACIÓN-02', subtitle:'Subestación eléctrica flotante', scenario:'Toda la electricidad que generan los paneles solares, los aerogeneradores y las turbinas mareomotrices llega primero a un punto central en medio del mar, antes de viajar hasta las casas en tierra.', question:'¿Para qué sirve una subestación eléctrica en un parque marino?', options:['Para guardar las piezas de repuesto del parque.','Para transformar y enviar la electricidad hacia tierra.','Para limpiar los paneles solares.','Para vigilar con cámaras el parque.'], correct:1, hint:'Piensa en qué hace falta antes de enviar la electricidad a tierra.', assetIndex:1},
